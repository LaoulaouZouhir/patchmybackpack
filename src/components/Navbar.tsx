  ...
  return (
    <nav className="sticky top-0 z-40 border-b border-hairline bg-canvas/85 backdrop-blur-xl">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        {/* Brand Logo & Wordmark */}
        <a href="#" className="flex items-center gap-2.5 text-[15px] font-semibold tracking-[-0.02em] text-ink hover:opacity-80 transition-opacity shrink-0 whitespace-nowrap">
          <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-surface-200 text-cognac shrink-0">
            <Backpack className="h-4 w-4" />
          </div>
          <span className="whitespace-nowrap">Patch My Backpack</span>
        </a>
        ...
        <div className="hidden items-center gap-4 lg:gap-5 text-[13px] font-medium text-ink-muted md:flex whitespace-nowrap">
          ...
          <a href="#goal" className="transition-colors hover:text-ink whitespace-nowrap">The goal</a>
          ...
          <a href="#faq" className="transition-colors hover:text-ink whitespace-nowrap">FAQ</a>
        </div>
